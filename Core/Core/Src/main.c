...
int main(void)
{
  ...
  while (1)
  {
      ...
      if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_RESET)
      {
          ...
          HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0 | GPIO_PIN_3 | GPIO_PIN_4 |
      ...
      else if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_1) == GPIO_PIN_RESET)
      {
          ...
          // Digit 2 (FIXED FOR YOUR CURRENT WIRING)
          HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0 | GPIO_PIN_2 |
      ...
      else
      {
          ...
          HAL_GPIO_WritePin(GPIOC,GPIO_PIN_6 | GPIO_PIN_1 | GPIO_PIN_2 |
